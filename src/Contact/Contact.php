...
class Contact
{
  ...
  public static function contact_form(\WP_REST_Request $request)
  {
    ...
    if (GET == $request->get_method()) {
      ...
      $captcha_settings = \Paseo\Admin\Settings\Settings::get_settings();
      ...
      $result->header(\CAPTCHA, $captcha_settings['captcha_public_key']);
      $result->set_data(
        array(
          'captcha_site_key' => $captcha_settings['captcha_public_key']
        )
      );
    }
